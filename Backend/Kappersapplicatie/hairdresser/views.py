...
from .models import Article, Author, Appointment, Customer, Geslacht
from .serializers import ArticleSerializer, AuthorSerializer, ArticleSerializer, AppointmentSerializer, CustomerSerializer


class GeslachtView(APIView):
